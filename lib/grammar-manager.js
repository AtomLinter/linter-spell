...
export default class GrammarManager extends Disposable {
  ...
  consumeGrammar (grammars, languageManager) {
    ...
    if (textEditor) languageManager.getLanguages(textEditor)
